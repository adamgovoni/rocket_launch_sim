...
pygame.display.set_caption("🚀 Dual-Booster Rocket Simulator with HUD")
...
SCALE = (HEIGHT - 100) / max_display_alt  # pixels per meter
...
while altitude >= 0:
    ...
    for i, line in enumerate(hud_lines):
        ...
        screen.blit(text, (WIDTH - 280, 40 + i * 30))

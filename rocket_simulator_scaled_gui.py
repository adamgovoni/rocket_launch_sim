...
pygame.display.set_caption("🚀 Scaled Calculus Rocket Simulator")
...
while altitude >= 0:
    ...
    max_alt_so_far = max(positions)
    SCALE = (HEIGHT - 100) / max(max_alt_so_far, 1)  # pixels per meter

    # Draw vertical ruler
    for a in range(0, int(max_alt_so_far) + 100, 100):
